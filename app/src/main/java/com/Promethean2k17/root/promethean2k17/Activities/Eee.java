...
public class Eee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/eee/solar.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images//eee/matlab.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/eee/emcd.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/eee/paper.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/eee/poster.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/eee/quiz.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/eee/ttp.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/eee/circuit.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/eee/peechakucha.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/eee/circution.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/ece/lab.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/eee/greenpaper.jpg"));
        arrayList.add(new Eee_Model("http://23.92.25.213/promethean2k17/images/eee/project.jpg"));
