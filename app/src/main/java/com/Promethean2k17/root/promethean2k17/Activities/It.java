...
import com.Promethean2k17.root.promethean2k17.Adapters.It_Adapter;
import com.Promethean2k17.root.promethean2k17.Models.It_Model;
...
It_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView= findViewById(R.id.it_recyclerview);

        ArrayList<It_Model> arrayList = new ArrayList<>();
        arrayList.add(new It_Model("http://23.92.25.213/promethean2k17/images/it/makeabot.jpg"));
        arrayList.add(new It_Model("http://23.92.25.213/promethean2k17/images/it/etoys.jpg"));
        arrayList.add(new It_Model("http://23.92.25.213/promethean2k17/images/it/poster.jpg"));
        arrayList.add(new It_Model("http://23.92.25.213/promethean2k17/images/it/paper.jpg"));
        arrayList.add(new It_Model("http://23.92.25.213/promethean2k17/images/it/exquizme.jpg"));
        arrayList.add(new It_Model("http://23.92.25.213/promethean2k17/images/it/masterorator.jpg"));
        arrayList.add(new It_Model("http://23.92.25.213/promethean2k17/images/it/techsnake.jpg"));
        arrayList.add(new It_Model("http://23.92.25.213/promethean2k17/images/it/techgear.jpg"));
        arrayList.add(new It_Model("http://23.92.25.213/promethean2k17/images/it/tictactech.jpg"));
        arrayList.add(new It_Model("http://23.92.25.213/promethean2k17/images/it/soundout.jpg"));
