...
Bme_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new Bme_Model("http://promethean2k17.com/app/images/bme/guest.jpg"));
        arrayList.add(new Bme_Model("http://promethean2k17.com/app/images/bme/paper.jpg"));
        arrayList.add(new Bme_Model("http://promethean2k17.com/app/images/bme/poster.jpg"));
        arrayList.add(new Bme_Model("http://promethean2k17.com/app/images/bme/medquizard.jpg"));
        arrayList.add(new Bme_Model("http://promethean2k17.com/app/images/bme/slide.jpg"));
        arrayList.add(new Bme_Model("http://promethean2k17.com/app/images/bme/haunted.jpg"));
        arrayList.add(new Bme_Model("http://promethean2k17.com/app/images/bme/guess.jpg"));
