...
import com.Promethean2k17.root.promethean2k17.Adapters.Bme_Adapter;
import com.Promethean2k17.root.promethean2k17.Models.Bme_Model;
...
Bme_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView= findViewById(R.id.bme_recyclerview);

        ArrayList<Bme_Model> arrayList = new ArrayList<>();
        arrayList.add(new Bme_Model("http://23.92.25.213/promethean2k17/images/bme/guest.jpg"));
        arrayList.add(new Bme_Model("http://23.92.25.213/promethean2k17/images/bme/paper.jpg"));
        arrayList.add(new Bme_Model("http://23.92.25.213/promethean2k17/images/bme/poster.jpg"));
        arrayList.add(new Bme_Model("http://23.92.25.213/promethean2k17/images/bme/medquizard.jpg"));
        arrayList.add(new Bme_Model("http://23.92.25.213/promethean2k17/images/bme/slide.jpg"));
        arrayList.add(new Bme_Model("http://23.92.25.213/promethean2k17/images/bme/haunted.jpg"));
        arrayList.add(new Bme_Model("http://23.92.25.213/promethean2k17/images/bme/guess.jpg"));
