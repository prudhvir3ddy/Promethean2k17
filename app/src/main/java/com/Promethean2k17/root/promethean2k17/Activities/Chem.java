...
Chem_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new Chem_Model("http://promethean2k17.com/app/images/chem/process.jpg"));
        arrayList.add(new Chem_Model("http://promethean2k17.com/app/images/chem/paper.jpg"));
        arrayList.add(new Chem_Model("http://promethean2k17.com/app/images/chem/poster.jpg"));
        arrayList.add(new Chem_Model("http://promethean2k17.com/app/images/chem/quiz.jpg"));
        arrayList.add(new Chem_Model("http://promethean2k17.com/app/images/chem/chemhunt.jpg"));
        arrayList.add(new Chem_Model("http://promethean2k17.com/app/images/chem/chemystory.jpg"));
        arrayList.add(new Chem_Model("http://promethean2k17.com/app/images/chem/chemflash.jpg"));
