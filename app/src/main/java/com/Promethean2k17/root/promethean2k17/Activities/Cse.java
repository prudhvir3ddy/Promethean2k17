...
Cse_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/web.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/python.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/ibm.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/paper.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/poster.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/techmaze.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/codechef.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/erudite.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/technoladder.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/codevyuha.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/decoderace.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/readyplayer.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/coderunner.jpg"));
        arrayList.add(new Cse_Model("http://23.92.25.213/promethean2k17/images/cse/mock.jpg"));
